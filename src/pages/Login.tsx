...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-primary/4 blur-[150px]" />
        ...
        <div className="rounded-3xl surface-elevated border border-border/30 p-6 overflow-hidden relative">
          ...
          <div className="relative">
            <div className="text-center mb-5">
              ...
              <h1 className="text-lg font-bold mt-2">Willkommen zurück!</h1>
            </div>
