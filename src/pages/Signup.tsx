...
const Signup = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    toast.success("Account erstellt! Check deine Emails 💌");
    navigate("/dashboard");
  };
        ...
        <div className="rounded-3xl glass-card p-7 overflow-hidden relative">
          ...
          <div className="relative">
            <div className="text-center mb-6">
              ...
              <h1 className="text-xl font-extrabold mt-3">Join the Club!</h1>
              <p className="text-[13px] text-muted-foreground mt-1">Erstelle dein Konto und starte</p>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-3.5">
              ...
              >
                {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : <>Account erstellen 💅 <ArrowRight className="h-4 w-4" /></>}
              </button>
            </form>
