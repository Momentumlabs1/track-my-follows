  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-accent/5 blur-[120px] animate-pulse-glow" />
      </div>
      ...
      >
        ...
        <div className="rounded-2xl bg-card border border-border/50 p-6">
          <h1 className="text-xl font-bold text-center mb-6">Konto erstellen</h1>
