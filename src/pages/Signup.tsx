  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative">
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-brand-cyan/3 blur-[150px]" />
      </div>
      ...
      >
        ...
        <div className="rounded-xl surface-elevated border border-border/40 p-6 noise overflow-hidden relative">
          ...
          <h1 className="text-lg font-bold text-center mb-5">Create account</h1>
