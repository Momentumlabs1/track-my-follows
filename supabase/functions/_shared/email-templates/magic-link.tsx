...
export const MagicLinkEmail = ({
  confirmationUrl = "https://spy-secret.com/login",
  siteName = "Spy-Secret",
}: MagicLinkEmailProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={outerContainer}>
        <Section style={card}>
          ...
          <Heading style={heading}>Einloggen</Heading>
          <Text style={paragraph}>
            Klicke auf den Button, um dich einzuloggen. Der Link ist 60 Minuten gültig.
          </Text>
