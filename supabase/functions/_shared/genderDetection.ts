...
// Ported from src/lib/genderDetection.ts — 1,677 names + NFKD normalization + nicknames + suffix heuristics
...
export function detectGender(fullName: string | null | undefined): string {
